          ...
          <div className="containerSpace">
            ...
            <div className="spaceReservations">
              ...
              <p className="spacePrice">
                {selectedSpace.costperday + "€"} / day
              </p>
              <p className="reserveOnlineP">Reserve online</p>
              <Link
                className="reserveSpaceButton"
                to={`/space/${id}/select-date`}
              >
                <p>Reserve space</p>
              </Link>
              <div className="hrOr">
              ...
              <p>
                Visit this space in person following our new safety measures.
              </p>
              <Link className="bookTourButton" to={`/space/${id}/book-tour`}>
                <p>Book a Tour</p>
              </Link>
            </div>
            <div className="spaceImages">
              <div className="openingHours">
                ...
                <div className="dataInfo1">
                  ...
                  <p>
                    {selectedSpace.opendays_from}
                    {" - "}
                    {selectedSpace.opendays_to}
                  </p>
                </div>
                <div className="dataInfo2">
                  <img src={schedule}></img>
                  <p>
                    {selectedSpace.openhours_from}
                    {" - "}
                    {selectedSpace.openhours_to}
                  </p>
                </div>
              </div>
